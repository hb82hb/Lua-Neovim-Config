...
_G.packer_plugins = {
  ...
  ["nightfox.nvim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/nightfox.nvim",
  ...
  ["nvim-treesitter-refactor"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/nvim-treesitter-refactor",
  ...
  ["vim-code-dark"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/vim-code-dark",
